...
public class FilterActivity extends AppCompatActivity {
    ...
    String statee_id,cityy_id,keywordd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statee_id = intent.getStringExtra("statee_id");
        cityy_id = intent.getStringExtra("cityy_id");
        keywordd = intent.getStringExtra("keywordd");
        ...
        Log.e("eeeee",""+Constant.API_HOME_FILTER+usr_id+"&sid="+statee_id+"&lid="+cityy_id);
    ...
    protected void onResume() {
        ...
        try {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    new FilterActivity.ReadJSON2().execute(Constant.API_HOME_FILTER+usr_id+"&sid="+statee_id+"&lid="+cityy_id+"&keyword="+keywordd);
