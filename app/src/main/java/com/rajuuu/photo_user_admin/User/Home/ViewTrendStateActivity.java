...
public class ViewTrendStateActivity extends AppCompatActivity {

    ArrayList<ViewSingleCatProductModel> arrayList;
    ListView lv;
    public static CustPrograssbar custPrograssbar;
    Toolbar toolbar;
    String cidd,namee,usr_id,state_idd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_trend_state);
    ...
    protected void onResume() {
        ...
        try {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    new ViewTrendStateActivity.ReadJSON2().execute(Constant.API_TREND_STATE+usr_id+"&sid="+state_idd);
